...
const ChangePassword = () => {
    ...
    const [inputValue, setInputValue] = useState({
      ...
      const checkInValid = () => {
        let isValid = false;
        if(!isEmpty(inputValue.oldPassword) && !isEmpty(inputValue.newPassword) && !isEmpty(inputValue.confirmPassword))
        {
          isValid= true;
        }
        else{
        ...
        <div className="d-flex justify-content-center p-5">
          <div className="content_changePassword">
              <div className="from_group">
                ...
                <input type="text" value={inputValue.oldPassword} onChange={(e) => setInputValue({
                  ...inputValue,
              ...
              <div className="from_group">
                ...
                <input type="text" value={inputValue.newPassword} onChange={(e) => setInputValue({
                  ...inputValue,
              ...
              <div className="from_group">
                ...
                <input  type="text" value={inputValue.confirmPassword} onChange={(e) => setInputValue({
                  ...inputValue,
                  confirmPassword: e.target.value
                })}/>
              </div>
              <button className="change_password" onClick={handleSubmit}>Thay đổi mật khẩu</button>
            </div>
        </div>
    )
}
