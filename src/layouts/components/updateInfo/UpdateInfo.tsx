...
const UpdateInfo: React.FC<IUpdateInfoComponent> = ({
    userInfo = {}
}) => {
        ...
        <div className="container">
          ...
          <div className="content">
            <div className="from_group">
              <label>Họ tên *</label>
              <input  value={newInputValue?.name} onChange={e => setNewInputValue({
                ...newInputValue,
                name: e.target.value,
              })}/>
            </div>
            ...
            <div className="from_group">
              <label>SĐT </label>
              <input value={newInputValue?.phone} onChange={e => setNewInputValue({
                ...newInputValue,
            ...
            <div className="from_group">
              <label>Địa chỉ</label>
              <input value={newInputValue?.address} onChange={e => setNewInputValue({
                ...newInputValue,
            ...
            <div className="from_group">
              <label>Tuổi</label>
              <input value={newInputValue?.age} onChange={e => setNewInputValue({
                ...newInputValue,
            ...
            <div className="from_group">
              <label>CCCD</label>
              <input value={newInputValue?.identification} onChange={e => setNewInputValue({
                ...newInputValue,
