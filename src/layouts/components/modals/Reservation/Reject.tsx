...
const Reject: React.FC<IApprove> = ({open, onClose, onReject, reservationId}) => {
    const [formRejectReservation, setFormRejectReservation] = useState<IReservation>({
        reject_reason: '',
    });
    const handleReject = () => {
                ...
                <Card sx={{width: 800}}>
                    ...
                    <CardContent>
                        <Typography variant="body2" color="text.secondary">
                            Do you want to reject this reservation?<br/>
                        ...
                        <Form.Group className="mb-3">
                            <Form.Control
                                ...
                                onChange={e => setFormRejectReservation({
                    ...
                    <StyledCardActions>
                        <Button variant="contained" size="small" color={"success"} onClick={handleReject}>Reject</Button>
