            ...
            >
                <Modal.Body>
                    ...
                    <Form>
                        <Form.Group className="mb-3">
                            ...
                            <div className={'d-flex align-items-center'}>
                                <p className={'m-auto me-2'} style={{fontWeight: "bold"}}>Từ: </p>
                                <Form.Control type="text"
                                              placeholder="start date"
                                              value={data.start_date}
                                              readOnly
                                />
                                <p className={'m-auto me-2 ms-2'} style={{fontWeight: "bold"}}>Đến: </p>
                                <Form.Control type="text"
                    ...
                    <div className={'d-flex justify-content-end'}>
                        ...
                        <Button variant="primary" className={'me-2'} onClick={onConfirm}>Đặt phòng</Button>
                    </div>
                </Modal.Body>
            </Modal>
        </>
