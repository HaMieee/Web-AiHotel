  ...
  return (
    <div>
      ...
      <div className="d-flex flex-column align-items-center">
        ...
        <p>
          Nằm trên những tầng cao nhất của toà nhà 65 tầng tráng lệ, khách sạn
          Lotte Hà Nội tự hào là đại diện cho tiêu chuẩn khách sạn 5 sao quốc tế
          mới tại Hà Nội nói riêng và Việt Nam nói chung.
        </p>
        <button
          type="button"
