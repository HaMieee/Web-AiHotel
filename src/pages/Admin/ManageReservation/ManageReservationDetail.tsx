                ...
                <HeaderContainer>
                    <StyledButtonContainer>
                        {reservationState.status === 'pending' && (
                            <>
                                <StyledButton onClick={handleApproved} variant="contained" color="success">
                                    Approve
                                </StyledButton>
                                <StyledButton onClick={handleRejected} variant="contained" color="error">
                                    Reject
                                </StyledButton>
                            </>
                        )}
                        {reservationState.status === 'approved' && (
                            <>
                                <StyledButton variant="contained" color="primary" onClick={handleISCheckIn}>
                                    Check In
                                </StyledButton>
                                <StyledButton onClick={handleRejected} variant="contained" color="error">
                                    Reject
                        ...
                        {reservationState.status === 'processing' && (
                            <StyledButton variant="contained" color="primary" onClick={handleISCheckOut}>
                                Check Out
                            </StyledButton>
                        )}
                    ...
                    {!(reservationState.status === 'pending' || reservationState.status === 'approved' || reservationState.status === 'rejected') && (
