...
const ManageUser = () => {
    ...
    const metaState = useSelector((state: RootState) => state.manageUser.paginate);
        ...
        <>
            ...
            <div className={'d-flex justify-content-between mb-3'}>
                <Stack spacing={2} direction="row">
                    ...
                    <Button variant={roleType === 'employee' ? "contained" : "outlined"} onClick={() => handleFetchDataUsers('employee')}>Nhân viên</Button>
                </Stack>
                <Stack spacing={2} direction="row">
            ...
            <TableThree columns={['STT', 'Name', 'Phone', 'Address', 'Identification', 'Age', 'Email', 'Actions']}
                        rows={userData}
