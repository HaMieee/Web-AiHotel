...
const ManageService =  () => {
    ...
    const manageServiceState = useSelector((state: RootState) => state.manageService.services);
    const serviceDetailState = useSelector((state: RootState) => state.manageService.serviceDetail);
    const metaState = useSelector((state: RootState) => state.manageService.paginate);
    ...
    return(
        <>
            ...
            <TableThree columns={['STT', 'Name', 'Description', 'Price', 'Actions']}
                        rows={serviceData}
            ...
            <DeleteServiceModal isShow={showDelete} onClose={() => setShowDelete(false)} serviceDelete={serviceDetail} onConfirm={confirmDelete}/>
        </>
    )
}
