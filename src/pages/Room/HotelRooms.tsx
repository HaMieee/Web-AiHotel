...
const HotelRooms: React.FC<IHotelRooms> = ({
    ...
    const roomDetailState = useSelector((state: RootState) => state.manageRoom.roomDetail);
    ...
    return (
        <>
            <div className={'container-fluid'}>
                {!isEmpty(groupedRooms) && Object.keys(groupedRooms).map((floor, f_index) => (
                                            ...
                                            <div className={'ms-3'} style={{width: "60%", height: "100%"}}>
                                                ...
                                                >
                                                    ...
                                                    <div>
                                                        <Button
                                                            size={'sm'}
                                                            onClick={() => handleShowDetail(room.id)}>Detail</Button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
