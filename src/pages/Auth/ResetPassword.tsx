...
const ResetPassword = () => {
    ...
    const [inputValue, setInputValue] = useState({
      ...
      const checkInValid = () => {
        let isValid = false;
        if(!isEmpty(inputValue.new_password) && !isEmpty(inputValue.password_confirm))
        {
          isValid= true;
        }
        else{
...
return(
    <>
        ...
        <div className="container_resetPassword">
          ...
          <div className="top">
          <input type="text" placeholder="Mật khẩu (*)" value={inputValue.new_password} onChange={(e) => setInputValue({
              ...inputValue,
              new_password: e.target.value
            })} />
          <input type="text" placeholder="Nhập lại mật khẩu (*)" value={inputValue.password_confirm} onChange={(e) => setInputValue({
              ...inputValue,
              password_confirm: e.target.value
            })}/>
          </div>
          <div className='reset'>
            <button type="submit" className='confirm' onClick={handleSubmit} >Gửi</button>
          </div>
        </div>
      </div>
    </>
